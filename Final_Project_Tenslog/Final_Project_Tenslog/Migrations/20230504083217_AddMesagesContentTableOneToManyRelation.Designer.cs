...
namespace Final_Project_Tenslog.Migrations
{
    ...
    [Migration("20230504083217_AddMesagesContentTableOneToManyRelation")]
    partial class AddMesagesContentTableOneToManyRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Final_Project_Tenslog.Models.Message", b =>
                {
                    ...
                    b.Property<string>("MessageForUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Final_Project_Tenslog.Models.Messages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Final_Project_Tenslog.Models.Message", b =>
                {
                    ...
                    b.HasOne("Final_Project_Tenslog.Models.AppUser", "MessageForUser")
                        .WithMany()
                        .HasForeignKey("MessageForUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Final_Project_Tenslog.Models.AppUser", "MessageFromUser")
                        .WithMany()
                        .HasForeignKey("MessageFromUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("MessageForUser");
            ...
            modelBuilder.Entity("Final_Project_Tenslog.Models.Messages", b =>
                {
                    b.HasOne("Final_Project_Tenslog.Models.Message", "Message")
                        .WithMany("Messages")
